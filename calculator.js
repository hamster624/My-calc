...
function pentate(num1, num2) {
  let result = num1;
  for (let i = 1; i < num2.toNumber(); i++) {
    result = result.tetr(num1); // Apply tetration iteratively
  }
  return result;
}

function hexate(num1, num2) {
  let result = num1;
  for (let i = 1; i < num2.toNumber(); i++) {
    result = pentate(result, num1); // Apply pentation iteratively
  }
  return result;
}
